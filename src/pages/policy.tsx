	...
	return (
		<VStack maxW="800px" mx="auto" px={4} py={8} spacing={8}>
			...
			<VStack align="start" spacing={4}>
				...
				<Text fontWeight="bold">6. 違法なコンテンツ</Text>
				<Text>
					本サイトにおいて暴力的または中傷的、性的、不正行為や差別を助長する、その他不適切な表現と判断した場合、掲載の削除等の措置を講じます。
				</Text>
				<Text fontWeight="bold">7. プライバシーポリシーの変更</Text>
				<Text>
					本サイトは、利用者に事前の通知なく、いつでもプライバシーポリシーを変更することができます。変更後のプライバシーポリシーは、本サイトに掲載した時点で効力を発揮します。
				</Text>
				<Text fontWeight="bold">8. 最終更新日</Text>
