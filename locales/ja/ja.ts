...
export default {
	...
	translate: {
		...
		langlist: {
			...
			PL: "ポーランド語",
			PTBR: "ポルトガル語（ブラジル）",
			PTPT: "ポルトガル語（ブラジル・ポルトガル語を除く全ポルトガル語圏）",
			RO: "ルーマニア語",
			RU: "ロシア語",
			SK: "スロバキア語",
			SL: "スロベニア語",
	...
	InstallGuide: {
		header: "アプリ簡易ガイド",
		note: "※※ 利用にあたっての注意事項 ※※",
		noteText1: "このアプリはブラウザの保存容量を使います。",
		noteText2: "ブラウザのCookieとサイトデータを消去すると全てのデータが消失します。",
		noteText3: "バックアップしてあるデータの復元は可能です。(ユーザー名とパスワードが必要)",
		noteText4: "ユーザーとパスワードが判らない場合データ復元はできません。",
		head1: "アプリのインストール方法",
		step1_1: "1.GoogleChromeの右上の三点リーダーからメニューを開く",
		step1_2: "2.保存して共有 → Re:teratureをインストール",
		step1_3: "3.インストールをクリック",
		head2: "データの保存設定の確認方法",
		step2_1: "1.三点リーダーからアプリの情報を選択",
		step2_2: "2.Cookieとサイトデータを選択",
		step2_3: "3.Cookieとサイトデータを管理するを選択",
		step2_4: "4.データの保存を許可するに設定(初期値は許可になっています)",
		step2_4Text: "この設定が許可になっていない場合、アプリは正常に動作しません",
		head3: "アンインストール方法",
		step3_1: "三点リーダーメニューからRe:teratureのアンインストールを選択",
		link: "その他詳しい使い方はコチラ",
		footer: "このガイドはヘッダーメニューからいつでも開けます",
		close: "閉じる"
	}
};
