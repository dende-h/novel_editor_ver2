					...
					(c.prototype.THROTTLE_TIMEOUT = 100),
						...
						(c._setupCrossOriginUpdater = function () {
							return (
								r ||
									(r = function (t, n) {
										(o = t && n ? h(t, n) : { top: 0, bottom: 0, left: 0, right: 0, width: 0, height: 0 }),
						...
						(c.prototype._unmonitorIntersections = function (e) {
							...
							if (-1 != n) {
								...
								if (
									...
									if (
										(this._monitoringDocuments.splice(n, 1), this._monitoringUnsubscribes.splice(n, 1), o(), e != r)
									) {
										var s = i(e);
								...
								for (var s, c, u, a, l, p, m, y, g = n, v = d(e), b = !1; !b && v; ) {
									...
									if (
										(w &&
											...
											(y = a - u),
											(g =
												((m = p - l) >= 0 && y >= 0 && { top: u, bottom: a, left: l, right: p, width: m, height: y }) ||
												null)),
										!g)
									)
										break;
		...
		(function (r, o) {
			...
			(u = function () {
				...
				function h(t) {
					var e = this;
					e.triggered ||
						((e.triggered = !0), e.def && (e = e.def), (e.msg = t), (e.state = 2), e.chain.length > 0 && s(u, e));
				}
				function p(t, e, n, r) {
						...
						((function () {
							...
							(r = (n = function (e, n) {
								...
								Object.defineProperty(this, '_updateSearchParams', {
									...
									value: function () {
										this.search !== l &&
											((l = this.search), a && ((u = !1), this.searchParams._fromString(this.search), (u = !0)));
									}
								});
							}).prototype),
