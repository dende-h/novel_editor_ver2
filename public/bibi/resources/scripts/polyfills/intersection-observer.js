					...
					(u.prototype.THROTTLE_TIMEOUT = 100),
						...
						(u._setupCrossOriginUpdater = function () {
							return (
								o ||
									(o = function (t, n) {
										(i = t && n ? f(t, n) : { top: 0, bottom: 0, left: 0, right: 0, width: 0, height: 0 }),
						...
						(u.prototype._unmonitorIntersections = function (e) {
							...
							if (-1 != n) {
								...
								if (
									...
									if (
										(this._monitoringDocuments.splice(n, 1), this._monitoringUnsubscribes.splice(n, 1), i(), e != o)
									) {
										var s = r(e);
								...
								for (var s, u, h, c, a, p, g, m, b = n, v = d(e), _ = !1; !_ && v; ) {
									...
									if (
										(y &&
											...
											(m = c - h),
											(b =
												((g = p - a) >= 0 && m >= 0 && { top: h, bottom: c, left: a, right: p, width: g, height: m }) ||
												null)),
										!b)
									)
										break;
