	...
	function (e, t, n) {
		...
		function c(e, t) {
			for (var n = {}, i = [], r = 0; r < e.length; r++) {
				...
				-1 !== l ? (a[l].references++, a[l].updater(f)) : a.push({ identifier: d, updater: v(f, t), references: 1 }),
					i.push(d);
			}
			return i;
		}
			...
			if (!window['bibi:jo']) {
				...
				(e.Bibi = function () {
					...
					(e.callBibi = function (n) {
						...
						try {
							if (n instanceof HTMLElement) {
								if (/^iframe$/i.test(n.tagName)) {
									...
									if (!l) return null;
									(u = n.parentNode.insertBefore(e.create('a', { href: l }), n)), (c = n.parentNode.removeChild(n));
						...
						var b,
							p = (u.Bibi = c.Bibi = { Jo: e, Anchor: u, Frame: c, Receiver: s, Index: e.Bibis.length, Status: '' });
						return (
					...
					window.addEventListener(
						...
						function (t) {
							...
							try {
								if (
									((Data = JSON.parse(Data)), 'object' != ('undefined' == typeof Data ? 'undefined' : i(Data)) || !Data)
								)
									return !1;
