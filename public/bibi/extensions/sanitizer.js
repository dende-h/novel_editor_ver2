 ...
 */ !(function (e) {
	...
	11: function (e, t, n) {
		...
		!(function (a, l) {
			'object' == i(t) && void 0 !== e
				? (e.exports = l())
				: void 0 === (o = 'function' == typeof (r = l) ? r.call(t, n, t, e) : r) || (e.exports = o);
		})(0, function () {
			'use strict';
			...
			return (function e() {
				...
				var ue = F,
					...
					Ve = function (e) {
						(Be && Be === e) ||
							...
							(Ge = 'ADD_URI_SAFE_ATTR' in e ? E(M(We), e.ADD_URI_SAFE_ATTR) : We),
							(Pe = 'ADD_DATA_URI_TAGS' in e ? E(M(Ue), e.ADD_DATA_URI_TAGS) : Ue),
				...
				var Xe = function (e) {
						...
						return ('noscript' === r && A(/<\/noscript/i, e.innerHTML)) ||
							...
							: (!Ee ||
							  ...
							  Me &&
									...
									(t = v(t, ue, ' ')),
									(t = v(t, de, ' ')),
									e.textContent !== t && (m(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
					...
					nt = function (e) {
						...
						var c = e.attributes;
						if (c) {
							var s = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: be };
							for (l = c.length; l--; ) {
								var u = (t = c[l]),
									m = u.name,
									h = u.namespaceURI;
								if (
									...
									if ('name' === i && 'IMG' === e.nodeName && c.id)
										(a = c.id), (c = y(c, [])), Ye('id', e), Ye(m, e), d(c, a) > l && e.setAttribute('id', a.value);
									else {
										if ('INPUT' === e.nodeName && 'type' === i && 'file' === o && s.keepAttr && (be[i] || !Se[i]))
											continue;
				...
				return (
					(n.sanitize = function (e, r) {
						...
						if ((ke || Ve(r), (n.removed = []), 'string' == typeof e && (Fe = !1), Fe));
							...
							(1 === (a = (o = $e('\x3c!--\x3e')).ownerDocument.importNode(e, !0)).nodeType && 'BODY' === a.nodeName) ||
							'HTML' === a.nodeName
								? (o = a)
								: o.appendChild(a);
						else {
						...
						if (Re) {
							if (we) for (u = le.call(o.ownerDocument); o.firstChild; ) u.appendChild(o.firstChild);
							else u = o;
