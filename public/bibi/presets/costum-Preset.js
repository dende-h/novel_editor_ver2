...
Bibi.preset({
	...
	bookshelf: 'https://enjzxtbbcyrptkkutovq.supabase.co/storage/v1/object/public/epub/bibi-bookshelf', // Relative path from this preset file to the bookshelf directory. "/" at the end is ignored. (To use a path begins with "http(s)://", read <01> at the bottom of this preset file.)
	...
	extensions: [
		...
		{ src: '../extensions/unaccessibilizer.js' }
	],
	...
	/* !!!! BE CAREFUL !!!! */ 'trustworthy-origins': ['https://enjzxtbbcyrptkkutovq.supabase.co'], // origins you trust other than where this Bibi is installed. (blank is recommended).
